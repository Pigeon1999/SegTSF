...
def data_provider(config):
    if config.dataset == "ETTh1.csv" or config.dataset == "ETTh2.csv":
        train_dataset = Dataset_ETT_hour(
            ...
            size=[config.seq_len, getattr(config, 'label_len', 0), config.pred_len],
    ...
    elif config.dataset == "ETTm1.csv" or config.dataset == "ETTm2.csv":
        ...
        vali_dataset = Dataset_ETT_minute(
            flag='val',
            features='M', # M: multivariate, S: univariate
            size=[config.seq_len, getattr(config, 'label_len', 0), config.pred_len],
            data_path=config.dataset
        )
    elif config.dataset == "electricity.csv" or config.dataset == "traffic.csv" or config.dataset == "weather.csv" or config.dataset == "Solar.csv" or config.dataset == "exchange_rate.csv":
